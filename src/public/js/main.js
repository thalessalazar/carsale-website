...
(function ($) {
    ...
    $(".car__details__pic__slider").owlCarousel({
        loop: true,
        margin: 0,
        items: 1,
        dots: true,
    ...
    $("#amount").val("R$" + $(".price-range").slider("values", 0) + ",00 - R$" + $(".price-range").slider("values", 1) + ",00");
    ...
    carSlider.slider({
        ...
        values: [900, 3000],
        slide: function (event, ui) {
            $("#caramount").val("R$" + ui.values[0] + ",00 - R$" + ui.values[1] + ",00");
        }
    });
    ...
    filterSlider.slider({
        ...
        values: [15000, 55000],
        slide: function (event, ui) {
            $("#filterAmount").val("R$" + ui.values[0] + ",00 - R$" + ui.values[1] + ",00");
        }
    });
    $("#filterAmount").val("R$" + $(".filter-price-range").slider("values", 0) + ",00 - R$" + $(".filter-price-range").slider("values", 1) + " ");
